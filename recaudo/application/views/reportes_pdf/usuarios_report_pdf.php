    ...
    <table style="width: 100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size: 10px;"><?php echo $row->nombres ?></td>
                <td style="font-size: 10px;"><?php echo utf8_encode($row->apellidos) ?></td>
                <td style="font-size: 10px;"><?php echo utf8_encode($row->correo) ?></td>
                <td style="font-size: 10px;"><?php echo $row->telefono ?></td>
                <td style="font-size: 10px;"><?php echo $row->ultimo_inicio ?></td>
                <td style="font-size: 10px;"><?php echo $row->modulos ?></td>
                <td style="font-size: 10px;"><?php echo $row->activo ?></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
