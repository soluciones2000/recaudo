        ...
        <div class="card">
            ...
            <div class="card-body">
            	<form id="form-filter" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="lead">Nombre del tipo de transaccion</p>
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="NombreTipoTransaccion_filtro">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <p class="lead">Signo del tipo de transaccion</p>
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="signoTipoTransaccion_filtro">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <table id="table" class="table table-striped table-bordered" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th>Signo del tipo de transaccion</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url('Tipo_transaccion/ajax_list')?>",
                "type": "POST",
                "data": function (data)
    			{    // are send to the server side
    				data.NombreTipoTransaccion_ajaxfiltro = $('#NombreTipoTransaccion_filtro').val(); 
                    data.signoTipoTransaccion_ajaxfiltro = $("#signoTipoTransaccion_filtro").val();
    ...
    {
        $.ajax({
            url: "<?php echo base_url('Tipo_transaccion/get_list_empresas')?>",
            dataType:"JSON",
            type: "POST",
    ...
    function reporte_pdf()
    {
        var parametros = {// are send to the server side
            ...
            NombreTipoTransaccion_ajaxreporte : $('#NombreTipoTransaccion_filtro').val(),
            signoTipoTransaccion_ajaxreporte : $('#signoTipoTransaccion_filtro').val(),
            FechaRegistro_ajaxreporte : $('#FechaRegistro_filtro').val(),
        };

        $.ajax({
            url: '<?php echo base_url("Tipo_transaccion/reporte");?>',
            type: "POST",
            dataType: 'JSON',
            data: parametros,
            success: function(data)
    ...
    function detalles_ajax(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url('Tipo_transaccion/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                {
                    $('[name="id"]').val(data.id);
                    $('[name="NombreTipoTransaccion_form"]').val(data.NombreTipoTransaccion);
                    $('[name="signoTipoTransaccion_form"]').val(data.signoTipoTransaccion);
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url('Tipo_transaccion/ajax_add')?>";
        } else {
            url = "<?php echo base_url('Tipo_transaccion/ajax_update')?>";
        }
    ...
    function borrar_ajax(id)
    {
        if(confirm('Esta seguro de querer borrar esta información?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url('Tipo_transaccion/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input name="NombreTipoTransaccion_form" placeholder="Nombre del tipo de transaccion" class="form-control" type="text" maxlength="200">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input name="signoTipoTransaccion_form" placeholder="Signo del tipo de transaccion" class="form-control" type="text" maxlength="1">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input name="FechaRegistro_form" class="form-control" type="date" maxlength="15">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
