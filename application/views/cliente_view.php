            ...
            <div class="card-body">
            	<form id="form-filter" class="form-horizontal">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="NombreCliente_filtro">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
...
<script type="text/javascript">
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
    			...
    			{    // are send to the server side
    				data.NombreCliente_ajaxfiltro = $('#NombreCliente_filtro').val(); 
    ...
    {
        $.ajax({
            url: "<?php echo base_url('Cliente/get_list_empresas')?>",
            dataType:"JSON",
            type: "POST",
    ...
    function detalles_ajax(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                {
                    $('[name="id"]').val(data.id);
                    $('[name="NombreCliente_form"]').val(data.NombreCliente);
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url('Cliente/ajax_add')?>";
        } else {
            url = "<?php echo base_url('Cliente/ajax_update')?>";
        }
    ...
    function borrar_ajax(id)
    {
        if(confirm('Esta seguro de querer borrar esta información?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url('Cliente/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input name="NombreCliente_form" placeholder="Nombre del Cliente" class="form-control" type="text" maxlength="50">
