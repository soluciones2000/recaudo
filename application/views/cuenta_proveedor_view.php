...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url('Cuenta_proveedor/ajax_list')?>",
                "type": "POST",
                "data": function (data)
    ...
    {
        $.ajax({
            url: "<?php echo base_url('Cuenta_proveedor/get_list_empresas')?>",
            dataType:"JSON",
            type: "POST",
    ...
    function reporte_pdf()
    {
        ...
        $.ajax({
            url: '<?php echo base_url("Cuenta_proveedor/reporte");?>',
            type: "POST",
            dataType: 'JSON',
            data: parametros,
            success: function(data)
    ...
    {
        $.ajax({
            url: "<?php echo base_url('Cuenta_proveedor/cargar_proveedor')?>",
            dataType:"JSON",
            type: "POST",
            success: function(data)
            {
    ...
    {
        $.ajax({
            url: "<?php echo base_url('Cuenta_proveedor/cargar_cliente')?>",
            dataType:"JSON",
            type: "POST",
            success: function(data)
            {
    ...
    function detalles_ajax(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url('Cuenta_proveedor/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url('Cuenta_proveedor/ajax_add')?>";
        } else {
            url = "<?php echo base_url('Cuenta_proveedor/ajax_update')?>";
        }
    ...
    function borrar_ajax(id)
    {
        if(confirm('Esta seguro de querer borrar esta información?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url('Cuenta_proveedor/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="col-md-6">
                    <h3 class="modal-title" style="text-align: left;"></h3>
                </div>
                <div class="col-md-6">
