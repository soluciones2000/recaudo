    ...
    <table style="width: 100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size: 10px;"><?php echo $row->ci_rif ?></td>
                <td style="font-size: 10px;"><?php echo utf8_encode($row->nombres) ?></td>
                <td style="font-size: 10px;"><?php echo utf8_encode($row->apellidos) ?></td>
                <td style="font-size: 10px;"><?php echo $row->fecha_contrato ?></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
