            ...
            <div class="card-body">
            	<form id="form-filter" class="form-horizontal">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="NombreCategoria_filtro">
                        </div>
                    </div>
                    <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url('Categoria_producto/ajax_list')?>",
                "type": "POST",
                "data": function (data)
    			{    // are send to the server side
    				data.NombreCategoria_ajaxfiltro = $('#NombreCategoria_filtro').val(); 
                }
            },
    ...
    {
        $.ajax({
            url: "<?php echo base_url('Categoria_producto/get_list_empresas')?>",
            dataType:"JSON",
            type: "POST",
    ...
    function reporte_pdf()
    {
        var parametros = {// are send to the server side
            ...
            NombreCategoria_ajaxreporte : $('#NombreCategoria_filtro').val(),
        };

        $.ajax({
            url: '<?php echo base_url("Categoria_producto/reporte");?>',
            type: "POST",
            dataType: 'JSON',
            data: parametros,
            success: function(data)
    ...
    function detalles_ajax(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url('Categoria_producto/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                {
                    $('[name="id"]').val(data.id);
                    $('[name="NombreCategoria_form"]').val(data.NombreCategoria);
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url('Categoria_producto/ajax_add')?>";
        } else {
            url = "<?php echo base_url('Categoria_producto/ajax_update')?>";
        }
    ...
    function borrar_ajax(id)
    {
        if(confirm('Esta seguro de querer borrar esta información?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url('Categoria_producto/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input name="NombreCategoria_form" placeholder="Nombre de la categoria" class="form-control" type="text" maxlength="50">
