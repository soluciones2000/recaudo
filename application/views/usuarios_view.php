    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="col-md-6">
                    <h3 class="modal-title text-left">Formulario de <?php echo $titulo ?></h3>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="row">
                            <label class="control-label col-md-6">Nombres del usuario</label>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <label class="control-label col-md-6">Apellidos del usuario</label>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <label class="control-label col-md-12" style="text-align: center;">Modulos</label>
                            <label class="control-label col-md-12" style="text-align: center;">Nivel de seguridad</label>
                        </div>
                        <div class="row">
