            ...
            <div class="card-body">
            	<form id="form-filter" class="form-horizontal">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="NombreGestor_filtro">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url('Gestor/ajax_list')?>",
                "type": "POST",
                "data": function (data)
    			{    // are send to the server side
    				data.NombreGestor_ajaxfiltro = $('#NombreGestor_filtro').val(); 
    ...
    {
        $.ajax({
            url: "<?php echo base_url('Gestor/get_list_empresas')?>",
            dataType:"JSON",
            type: "POST",
    ...
    function detalles_ajax(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url('Gestor/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                {
                    $('[name="id"]').val(data.id);
                    $('[name="NombreGestor_form"]').val(data.NombreGestor);
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url('Gestor/ajax_add')?>";
        } else {
            url = "<?php echo base_url('Gestor/ajax_update')?>";
        }
    ...
    function borrar_ajax(id)
    {
        if(confirm('Esta seguro de querer borrar esta información?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url('Gestor/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input name="NombreGestor_form" placeholder="Nombre del Gestor" class="form-control" type="text" maxlength="50">
