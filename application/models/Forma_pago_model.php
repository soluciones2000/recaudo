...
class Forma_pago_model extends CI_Model {
	...
	var $table = 'formapago';
	var $column_order = array('NombreFormaPago', null); //set column field database for datatable orderable
	var $column_search = array('NombreFormaPago'); //set column field database for datatable searchable 
	var $order = array('NombreFormaPago' => 'asc'); // default order 
	var $id = "id";
	...
	private function _get_datatables_query()
	{
		...
		if($this->input->post('NombreFormaPago_ajaxfiltro'))
		{
			$this->db->like('NombreFormaPago', $this->input->post('NombreFormaPago_ajaxfiltro', TRUE));
		}
